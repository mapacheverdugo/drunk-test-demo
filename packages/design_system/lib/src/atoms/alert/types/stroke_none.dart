...
class _ForestAlertStrokeNone extends ForestAlertInterface {
  _ForestAlertStrokeNone({
...
class ForestAlertStrokeNone extends StatelessWidget {
  const ForestAlertStrokeNone({
    required this.title,
  ...
  Widget build(BuildContext context) {
    return _ForestAlertGeneric(
      ...
      alertInterface: _ForestAlertStrokeNone(
        alertType: alertType,
