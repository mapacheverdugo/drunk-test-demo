...
class _ForestAlertStrokeOneButton extends ForestAlertInterface {
  _ForestAlertStrokeOneButton({
...
class ForestAlertStrokeOneButton extends StatelessWidget {
  const ForestAlertStrokeOneButton({
    required this.title,
  ...
  Widget build(BuildContext context) {
    return _ForestAlertGeneric(
      ...
      alertInterface: _ForestAlertStrokeOneButton(
        alertType: alertType,
