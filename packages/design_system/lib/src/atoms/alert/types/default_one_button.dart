...
class _ForestAlertDefaultOneButton extends ForestAlertInterface {
  _ForestAlertDefaultOneButton({
...
class ForestAlertDefaultOneButton extends StatelessWidget {
  const ForestAlertDefaultOneButton({
    required this.title,
  ...
  Widget build(BuildContext context) {
    return _ForestAlertGeneric(
      ...
      alertInterface: _ForestAlertDefaultOneButton(
        alertType: alertType,
