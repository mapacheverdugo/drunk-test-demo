...
class _ForestAlertSmallElevatedTwoButton extends ForestAlertInterface {
  _ForestAlertSmallElevatedTwoButton({
...
class ForestSmallElevatedTwoButton extends StatelessWidget {
  const ForestSmallElevatedTwoButton({
    required this.title,
  ...
  Widget build(BuildContext context) {
    return _ForestAlertGeneric(
      ...
      alertInterface: _ForestAlertSmallElevatedTwoButton(
        alertType: alertType,
