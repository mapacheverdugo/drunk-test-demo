...
class _ForestAlertElevatedOneButton extends ForestAlertInterface {
  _ForestAlertElevatedOneButton({
...
class ForestAlertMediumElevatedOneButton extends StatelessWidget {
  const ForestAlertMediumElevatedOneButton({
    required this.title,
  ...
  Widget build(BuildContext context) {
    return _ForestAlertGeneric(
      ...
      alertInterface: _ForestAlertElevatedOneButton(
        alertType: alertType,
