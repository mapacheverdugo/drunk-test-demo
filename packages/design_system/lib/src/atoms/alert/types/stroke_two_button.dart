...
class _ForestAlertStrokeTwoButton extends ForestAlertInterface {
  _ForestAlertStrokeTwoButton({
...
class ForestStrokeTwoButton extends StatelessWidget {
  const ForestStrokeTwoButton({
    required this.title,
  ...
  Widget build(BuildContext context) {
    return _ForestAlertGeneric(
      ...
      alertInterface: _ForestAlertStrokeTwoButton(
        alertType: alertType,
